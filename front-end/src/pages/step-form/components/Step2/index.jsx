...
class Step2 extends React.Component {
  ...
  render() {
    ...
    const onValidateImage = e => {
      ...
      validateFields((err, values) => {
        if (!err) {
          if (dispatch) {
            dispatch({
              type: 'stepForm/submitImage',
              payload: { ...data, ...values, contract_image: this.state.base64Code},
            });
          }
        }
      });
    ...
    const contentForm = (<>
      <Form.Item {...formItemLayout} label="合同内容">
        {getFieldDecorator('contract_text', {
          rules: [
            {
              required: false,
    ...
    return (
      ...
      />
      <Form.Item {...formItemLayout} label="合同标题">
      ...
      <Form.Item {...formItemLayout} label="借贷方">
      ...
      <Form.Item {...formItemLayout} label="放贷方">
